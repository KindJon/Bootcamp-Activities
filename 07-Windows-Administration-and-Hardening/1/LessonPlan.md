...
In this module, you will be using a new Windows lab environment located in Windows Azure Lab Services [(labs.azure.com)](labs.azure.com). RDP into the **Windows RDP host machine** using the following credentials:
